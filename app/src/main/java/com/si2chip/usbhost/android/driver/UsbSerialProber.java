...
public class UsbSerialProber {
    ...
    public static com.si2chip.usbhost.android.driver.UsbSerialProber getDefaultProber() {
        return new com.si2chip.usbhost.android.driver.UsbSerialProber(getDefaultProbeTable());
    }
