...
public class ProbeTable {
     ...
     */
    public com.si2chip.usbhost.android.driver.ProbeTable addProduct(int vendorId, int productId,
    ...
    com.si2chip.usbhost.android.driver.ProbeTable addDriver(Class<? extends UsbSerialDriver> driverClass) {
        final Method method;
